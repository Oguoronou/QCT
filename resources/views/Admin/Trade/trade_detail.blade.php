                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                   <div class="row">
                        <div class="col-6">
                            ...
                            <div class="row">
                              <div class="col-lg-3 col-md-4 label">Créé le</div>
                              <div class="col-lg-9 col-md-8">{{ $tradeDetail->created_at ?? "1h" }}</div>
                            </div>
          
                            <div class="row">
                              <div class="col-lg-3 col-md-4 label">Échange depuis</div>
                        ...
                        <div class="col-6">
                            ...
                            <div class="row">
                              <div class="col-lg-3 col-md-4 label ">De la devise</div>
                              <div class="col-lg-9 col-md-8">{{ $tradeDetail->from_currency ?? "btc" }}</div>
                            </div>
          
                            <div class="row">
                              <div class="col-lg-3 col-md-4 label">À la devise</div>
