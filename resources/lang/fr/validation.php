...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | QCT affiche tout son contenu en français : ce fichier fournit les
    | traductions des messages de validation par défaut de Laravel afin que
    | $errors->all() (et le système de notifications global) n'affiche
    ...
    */
    ...
    'attributes' => [
        ...
        'images.*' => 'image',
        'status' => 'statut',
        'commissariat_id' => 'commissariat',
        'declaration_number' => 'numéro de déclaration',
        'receipt_photo' => 'photo du récépissé',
    ],
